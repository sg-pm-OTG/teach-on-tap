import { Home, Mic, FileText, Bell, User } from "lucide-react";
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/80 border-t border-border z-50 pb-[env(safe-area-inset-bottom)]">
      <div className="container max-w-md mx-auto">
        <div className="grid grid-cols-5 gap-1 px-2 py-2 pb-1">
          {navItems.map((item) => {
            ...
            return (
              <button
                ...
                className={cn(
                  "flex flex-col items-center justify-center py-2 px-2 rounded-lg transition-all min-h-[56px] active:scale-95",
                  isActive
